...
selecionados = []
print("Selected")
for i in select.get_residue_set_from_subset(nbr_selector.apply(clone_pose)):
    print(i)
    selecionados.append(i)

#### Aplicando residuos selecionados + vizinhos ao tf
tf.push_back(prevent_subset_repacking)

#### Printando parametros do packer criado
packer_task = tf.create_task_and_apply_taskoperations(clone_pose)
print(packer_task)
